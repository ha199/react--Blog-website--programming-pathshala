  ...
  return (
    <React.Fragment>
        ...
        <div className='login container'>
            ...
            {/* <Link to="/setpassword"><button type='submit' className='setPass'>Set Password</button></Link> */}
            <button type='submit' className='setPass'>Set Password</button>

            <p>OR</p>
            <button className='google' disabled> <FcGoogle/> Sign Up with Google</button>
